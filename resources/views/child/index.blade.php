        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 w-full flex-grow">
            ...
            <div class="bg-gradient-to-r from-blue-700 to-blue-500 rounded-3xl shadow-sm overflow-hidden">
                <div class="p-6 md:p-8 lg:p-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <!-- Tombol Tambah (Hanya Admin yang bisa klik, Kader tombolnya transparan/mati) -->
                    <div class="w-full md:w-auto shrink-0">
                        ...
                        @else
                            <div class="flex items-center justify-center gap-2 px-6 py-3 bg-white/40 text-white/70 font-semibold text-sm rounded-lg cursor-not-allowed w-full select-none" title="Akses khusus Administrator">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v16m8-8H4"></path>
                                </svg>
                                Tambah Data Balita (Khusus Admin)
                            </div>
                        @endif
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-blue-50 transition-colors">
                                    ...
                                    <td class="py-4 px-6 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            @if(auth()->check() && auth()->user()->role === 'administrator')
                                                <!-- Tombol Edit & Hapus Aktif untuk Admin -->
